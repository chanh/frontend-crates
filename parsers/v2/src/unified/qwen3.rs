...
mod tests {
    use super::*;
    use crate::unified::{
        UnifiedEvent, UnifiedParserEvent, UnifiedParserStartingState, UnifiedToolOutputMode,
        assemble,
    };
    ...
    fn reset_recovers_buffered_guided_text_and_restarts_lifecycle() {
        ...
        assert!(
            parser
                .initialize_with_state(UnifiedParserStartingState::Response)
                .is_err()
        );
...
mod guided_warning_tests {
    use super::*;
    use crate::tool_calling::traits::Tool;
    use crate::unified::{UnifiedParserEvent, UnifiedParserStartingState, UnifiedToolOutputMode};
...
mod reset_and_payload_tests {
    ...
    fn reset_does_not_leak_resume_reasoning_into_the_next_stream() {
        ...
        p.initialize_with_state(UnifiedParserStartingState::None)
            .unwrap();
